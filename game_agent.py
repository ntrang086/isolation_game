...
def custom_score(game, player):
    ...
    of the given player. This is my best heuristic function.

    The function calculates the difference between the number of the given player's 
    neighbors and that of their opponent's. The given player is incentivized to 
    move to locations that are next to as many unoccupied spaces as possible while
    trying to minimize their opponent's number of unoccupied neighbors. 
...
def custom_score_2(game, player):
    ...
    The function calculates the number of the given player's neighbors. The player 
    is incentivized to move to locations that are next to as many unoccupied spaces 
    as possible. 
...
def custom_score_3(game, player):
    ...
    The function considers both the distance of the player's location from 
    the center and the difference between the number of the given player's 
    neighbors and that of their opponent's. The player is incentivized to 
    move to locations that are both close to the center and that are next to 
    as many unoccupied spaces as possible, while trying to minimize their 
    opponent's number of unoccupied neighbors. 
    ...
    return -float((center_y - player_y)**2 + (center_x - player_x)**2) + float(own_neighbors - opp_neighbors) 


# Helper function to find the number of neighbors of the given player. 
# Neighbors are defined as locations that are 1 row or 1 column away from the 
# location of the specified player.
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def max_value(self, game, depth):
        """Helper function to be used by minimax. 
        Calculate the maximum score from the perspective of max player
        ...
        -------
        float
            The maximum score found in the current search; score of the current game state
            if there are no legal moves or depth is 1 or less        
        """
    ...
    def min_value(self, game, depth):
        """Helper function to be used by minimax. 
        Calculate the minimum score from the perspective of min player
        ...
        -------
        float
            The minimum score found in the current search; score of the current game state
            if there are no legal moves or depth is 1 or less        
        """        
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        try:
            ...
            # Perform iterative deepening if none of the above cases happened
            depth = 1
            while True:
    ...
    def max_value(self, game, depth, alpha, beta):
        """Helper function to be used by alphabeta. 
        Calculate the maximum score from the perspective of max player
